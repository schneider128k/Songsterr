...
GM = {
    # Standard GM drum map using canonical LilyPond drum names
    ...
    40: ('acousticsnare', 2, 'Electric Snare'),
    ...
    47: ('tommh',         2, 'Low-Mid Tom'),
    48: ('hightom',       2, 'High-Mid Tom'),
    ...
    62: ('highfloortom',  2, 'Mute Hi Conga'),
    63: ('hightom',       2, 'Open Hi Conga'),
    64: ('lowtom',        2, 'Low Conga'),
    65: ('tommh',         2, 'High Timbale'),
    66: ('lowfloortom',   2, 'Low Timbale'),
    # Songsterr-specific extensions beyond standard GM
    27: ('bassdrum',      2, 'CR-78 Bass (Songsterr ext.)'),
    92: ('halfopenhihat', 1, 'Half Open Hi-Hat (Songsterr ext.)'),
    93: ('ridecymbal',    1, 'Ride variant (Songsterr ext.)'),
